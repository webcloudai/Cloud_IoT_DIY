...
from project_deployment.project_navigator import AppProcessNavigator
...
def rerender_window(current_window:sg.Window, application:ProcessNavigator)->sg.Window:
    ...
    sg.theme('GreenTan')
    w = sg.Window('Project bootstrap', app_layout, finalize=True)
    add_enter_event(w)
    return w
...
if __name__=="__main__":
    ...
    #
    main_window = sg.Window('Project bootstrap', app_layout, finalize=True)
    ...
    while True:
        ...
        # 3. Check events from all windows
